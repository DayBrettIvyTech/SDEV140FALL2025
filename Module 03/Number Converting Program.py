...
if operation == "1":
    ...
    while not valid_binary_num:
        ...
        for digit in binary_number:
            if digit != "1" and digit != "0":
                print(f"The input contains a bad number, boo: {digit}")
                valid_binary_num = False
                break
    ...
    for segement in segements:
        hex_number = hex_number + binary_hex[segement]
    ...
    while not valid_num: 
        ...
        for digit in hex_number:
            if digit.upper() not in hex_digits:
                print("The input contains non hex digits: {digit}")
                valid_num = False
                break
